    ...
    public LlmToolSpec getDefinition() {
        ...
        props.put("manifest", Map.of(
                ...
                "description", "Full device manifest JSON defining the device behavior. " +
                        ...
                        "Optional: Icon (UI-only self-contained data:image), InternalVariables, EnvironmentDomains, ImpactedVariables, Contents. " +
                        ...
                        "Every ImpactedVariables name must have its domain in this same manifest: use an IsInside=false InternalVariable when the device also reads it in the model, or EnvironmentDomains when it only affects it. EnvironmentDomains does not create a device read/reference declaration. " +
