...
| [docs/guides/default-template-scenarios.md](guides/default-template-scenarios.md) | ✅ ready | Four additional importable default-template scenes covering fire response, rule priority, RFID trust/privacy, away-mode unlock, attack contrast, and verified repair | — |
